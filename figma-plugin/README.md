...
> **현재 범위:** 로그인 · 시안 목록 · **새 시안 만들기** · **기존 시안에 새 버전 올리기**.
> (개별 이미지 교체는 다음 단계.)
...
5. **기존 시안에 새 버전** 탭: 시안 검색/선택 → 항목의 "새 버전" → 선택 프레임이 새 버전으로 올라간다.
   - 프레임은 2x PNG로 내보낸다. 매우 큰 프레임은 25MB 제한에 걸릴 수 있다.
...
- 여러 안(variant) 중 선택해서 새 버전 올리기 (현재는 첫 번째 안에 올림)
